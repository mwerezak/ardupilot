...
// RushFPV MAX SOLO VTX SA2.1 supported power levels: 14, 27, 30, 34 dbm
AP_VideoTX::PowerLevel AP_VideoTX::_power_levels[VTX_MAX_POWER_LEVELS] = {
    // level, mw, dbm, dac
    { 0xFF,    0,    0, 0    }, // only in SA 2.1
    { 0,      10,   14, 7    },
    { 0x11,   25,   18, 0xFF }, // only in SA 2.1
    { 1,      80,   23, 16   },
    { 0x12,  200,   27, 0xFF }, // only in SA 2.1
    { 2,     250,   28, 25   },
    { 0x12,  400,   30, 0xFF }, // Tramp lies above power levels and always returns 25/100/200/400/600
    { 3,     800,   33, 40   },
    { 0x13, 1000,   34, 0xFF }, // only in SA 2.1
